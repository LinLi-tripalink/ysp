...
var JsInterface={
	...
	sendMsg:function(data){
        ...
        var _msg = '';
        if(msgtype==0){
			_msg = '<p><label class ="user_nickname" user_id='+data.ct.uid+'>'+data.ct.user_nicename+'</label> : <font color="#ffffff">进入房间</font></p>'  
        }else if(msgtype == 2) {
			_msg = '<p><label class ="user_nickname" user_id='+data.uid+'>'+data.uname+'</label> : <font color="#ffffff">'+data.ct+'</font></p>'  
        } 
