...
class Domain_Turntable {
	...
	public function turn($uid,$id,$liveuid,$stream) {
        ...
        $insert=array("type"=>'expend',"action"=>'yurntable_game',"uid"=>$uid,"touid"=>$uid,"giftid"=>0,"giftcount"=>$times,"totalcoin"=>$total,"addtime"=>$nowtime );
        ...
        foreach($win_list as $k=>$v){
            ...
            if($v['type']==1){
                ...
                $insert=array("type"=>'income',"action"=>'turntable_wins',"uid"=>$uid,"touid"=>$uid,"giftid"=>0,"giftcount"=>1,"totalcoin"=>$win_coin,"showid"=>$showid,"addtime"=>$nowtime );
                DI()->notorm->user_coinrecord->insert($insert);
            }
