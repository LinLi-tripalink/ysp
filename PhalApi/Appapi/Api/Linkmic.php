...
class Api_Linkmic extends PhalApi_Api {
	 ...
	 * @return string msg 提示信息
	 */
	/*public*/ private function MergeVideoStreamBF() {
		$rs = array('code' => 0, 'msg' => '', 'info' => array());
	...
	public function MergeVideoStream() {
		...
		$txcloud_secret_id = $configpri['live_txcloud_secret_id'];
		$txcloud_secret_key = $configpri['live_txcloud_secret_key'];
     ...
     * 合并流
     * @desc 合并流
     * @param  int txcloud_secret_id  腾讯云secretid
     * @param  string txcloud_secret_key 腾讯云secretkey
     * @param  int $uid  用户id
     * @param  array $mergeparams  混流参数
     */
