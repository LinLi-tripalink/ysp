...
class Api_Music extends PhalApi_Api {
     ...
     * @return int info[0].music_id 音乐id
     * @return string info[0].collecttime 音乐收藏时间
     * @return string info[0].title 音乐名称
     * @return string info[0].author 音乐演唱者
     * @return string info[0].img_url 音乐封面
     * @return string info[0].length 音乐长度
     * @return string info[0].file_url 音乐地址
     * @return int info[0].use_nums 音乐使用次数
     * @return int info[0].iscollect 是否收藏
     */
