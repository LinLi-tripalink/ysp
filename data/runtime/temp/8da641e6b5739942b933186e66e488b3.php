<?php /*a:2:{s:79:"/data/wwwroot/bjwz.yyyybbbb.com/themes/admin_simpleboot3/admin/video/index.html";i:1668570290;s:75:"/data/wwwroot/bjwz.yyyybbbb.com/themes/admin_simpleboot3/public/header.html";i:1668570290;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
		...
		<form class="well form-inline margin-top-20" method="post" action="<?php echo url('Video/index'); ?>">
			...
			<a class="btn btn-danger" href="<?php echo url('Admin/Video/index'); ?>">清空</a>
		</form>		
		
		<form method="post" class="js-ajax-form">
			<div class="table-actions">
				<button class="btn btn-danger btn-sm js-ajax-submit" type="submit" data-action="<?php echo url('Video/setBatchStatus',['status'=>1]); ?>"
                        data-subcheck="true">批量通过
                </button>
                <button class="btn btn-danger btn-sm js-ajax-submit" type="submit" data-action="<?php echo url('Video/setBatchStatus',['status'=>2]); ?>"
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							...
							<a class="btn btn-xs btn-primary" href="<?php echo url('Video/edit',array('id'=>$vo['id'],'from'=>'index')); ?>" >编辑</a>
							 <?php if($vo['isdel'] == '0'): ?>
							
							<a class="btn btn-xs btn-primary" href="javascript:void (0)" onclick="commentlists(<?php echo $vo['id']; ?>)" >评论列表</a>
						
							 <a class="btn btn-xs btn-danger" href="javascript:void (0)" onclick="del(<?php echo $vo['id']; ?>)" >删除</a><?php endif; ?>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
