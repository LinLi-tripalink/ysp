<?php /*a:2:{s:82:"/data/wwwroot/bjwz.yyyybbbb.com/themes/admin_simpleboot3/admin/setting/upload.html";i:1668570290;s:75:"/data/wwwroot/bjwz.yyyybbbb.com/themes/admin_simpleboot3/public/header.html";i:1668570290;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control"
                           ...
                           value="<?php echo (isset($upload_setting['file_types']['image']['extensions']) && ($upload_setting['file_types']['image']['extensions'] !== '')?$upload_setting['file_types']['image']['extensions']:'jpg,jpeg,png,gif'); ?>">
                </div>
            </div>
            <p class="help-block">允许上传大小默认为10240KB,1M=1024KB，允许上传格式默认为jpg,jpeg,png,gif</p>
        </div>
        <div class="form-group">
            <label>视频文件</label>
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control"
                           ...
                           title="扩展名,以英文逗号分隔"
                           placeholder="扩展名,以英文逗号分隔"
                           value="<?php echo (isset($upload_setting['file_types']['video']['extensions']) && ($upload_setting['file_types']['video']['extensions'] !== '')?$upload_setting['file_types']['video']['extensions']:'mp4'); ?>">
                </div>
            </div>
            <p class="help-block">允许上传大小默认为102400KB,1M=1024KB，允许上传格式默认为mp4</p>
        </div>
        <div class="form-group">
            <label>音频文件</label>
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control"
                           ...
                           title="扩展名,以英文逗号分隔"
                           placeholder="扩展名,以英文逗号分隔"
                           value="<?php echo (isset($upload_setting['file_types']['audio']['extensions']) && ($upload_setting['file_types']['audio']['extensions'] !== '')?$upload_setting['file_types']['audio']['extensions']:'mp3'); ?>">
                </div>
            </div>
            <p class="help-block">允许上传大小默认为10240KB,1M=1024KB，允许上传格式默认为mp3</p>
        </div>
        <div class="form-group">
            <label>附件</label>
            <div class="row">
