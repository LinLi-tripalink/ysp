<?php /*a:1:{s:64:"/data/wwwroot/bjwz.yyyybbbb.com/themes/default/portal/index.html";i:1668647294;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div id="fullpage">
			...
			<div class="section1_left fl">
				...
				<div class="download">
					<div class="ewm_area fl">
						<div class="ewm_img">
							<?php if($site_info['qr_url_ios'] != ''): ?>
								<img src="<?php echo $site_info['qr_url_ios']; ?>">
							<?php else: ?>
								<img src="/static/index/full_image/ewm.png">
							<?php endif; ?>
							
						</div>
						<div class="ewm_download ios"></div>
					</div>
					<div class="ewm_area fr mr_20">
						...
						<div class="ewm_download android"></div>
					</div>
				</div>
			</div>
	...
	<div class="section section2">
		...
		<?php if($site_info['copyright_url'] != ''): ?>
			<div class="copyright">
				<a href="<?php echo $site_info['copyright_url']; ?>" target="_blank"><?php echo (isset($site_info['copyright']) && ($site_info['copyright'] !== '')?$site_info['copyright']:''); ?></a>
			</div>
		<?php else: ?>
			<div class="copyright">
...
$(document).ready(function() {
	...
	$('#fullpage').fullpage({
		...
		lockAnchors:false,  //是否锁定锚链接，默认为false。设置为true时，锚链接anchors属性也没有效果。
