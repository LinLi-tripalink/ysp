<?php /*a:1:{s:73:"/data/wwwroot/bjwz.yyyybbbb.com/themes/admin_simpleboot3/admin/login.html";i:1668570290;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
    ...
    <div class="container">
        <div class="row">
            <div class="login_bd">
                ...
                <div class="bd_center">
                    <h1 class="text-center"><?php echo $siteInfo['sitename']; ?></h1>
...
<input type="hidden" name="_captcha_id" value="">
                    ...
                    <div class="png_float png_left" style="display:none;">
                        <img src="/themes/admin_simpleboot3/public/assets/images/login/left.png">
                    </div>
                    <div class="png_float png_right" style="display:none;">
