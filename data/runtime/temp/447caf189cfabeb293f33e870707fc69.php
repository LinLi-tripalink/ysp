<?php /*a:2:{s:85:"/data/wwwroot/bjwz.yyyybbbb.com/themes/admin_simpleboot3/admin/advert/lowervideo.html";i:1668570290;s:75:"/data/wwwroot/bjwz.yyyybbbb.com/themes/admin_simpleboot3/public/header.html";i:1668570290;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form class="well form-inline margin-top-20" method="post" action="<?php echo url('Advert/lowervideo'); ?>">
			关键字：			
			...
			<a class="btn btn-danger" href="<?php echo url('Admin/Advert/lowervideo'); ?>">清空</a>
		</form>	
		...
		<form method="post" class="js-ajax-form">
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<?php $isdel=array("0"=>"上架","1"=>"下架"); if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): if( count($lists)==0 ) : echo "" ;else: foreach($lists as $key=>$vo): ?>
					<tr>
						...
						<td align="center">	
							...
							<a class="btn btn-xs btn-primary" href="<?php echo url('Advert/edit',array('id'=>$vo['id'],'from'=>'lower')); ?>" >编辑</a>
							
							
							 <?php if($vo['isdel'] == '1'): ?>
							<a href="<?php echo url('Advert/set_shangjia',array('id'=>$vo['id'])); ?>" class="btn btn-xs btn-primary js-ajax-dialog-btn" data-msg="您确定要将该视频上架吗？">上架</a>
