<?php /*a:1:{s:79:"/data/wwwroot/bjwz.yyyybbbb.com/themes/admin_simpleboot3/admin/index/index.html";i:1668570290;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8">
    <title><?php echo (isset($site_info['sitename']) && ($site_info['sitename'] !== '')?$site_info['sitename']:''); ?> <?php echo lang('ADMIN_CENTER'); ?></title>
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;"><?php echo (isset($site_info['sitename']) && ($site_info['sitename'] !== '')?$site_info['sitename']:''); ?></a>
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <span class="user-info">
								<?php echo lang('WELCOME_USER',array('user_nickname' => empty($admin['user_nicename'] )? $admin['user_login'] : $admin['user_nicename'])); ?>
							</span>
